    ...
    while ((tokenMatch = tokenRegex.exec(workingText)) !== null) {
      ...
      switch (key) {
        ...
        case 'has': {
          ...
          if (flag === 'url' || flag === 'urls' || flag === 'link' || flag === 'links') hasUrls = true;
          if (flag === 'media' || flag === 'photo' || flag === 'file' || flag === 'attachment') hasMedia = true;
          if (flag === 'emoji' || flag === 'emojis') hasEmojis = true;
          break;
        }
      }
    }
